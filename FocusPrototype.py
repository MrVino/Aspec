    ...
    if args.live:
        ...
        while True:                
            try:
                ...
                #New key in the dictionary corresponding to the temperature
                peakwidths[temp] = {}
                ...
                #Check that this temperature input is indeed a number and not a letter or other character
                print("Please choose a number")
                continue
        ...
        try:
            ...
            while True:
                ...
                if inp == 'p':
                    #plot the laser peakwidths and their corresponding actuator position that have been taken up to this point
                    ...
                    #we use three 'stacked' subplots, each wavelength has its own subplot
                ...
                #the value of the actuator position
            ...
            #A bit of ad-hoc way to exit the interactive routine
        ...
        #The whole routine can also be done with files that have already been saved. The code below may have to be updated to correspond to the 'live' code above.
