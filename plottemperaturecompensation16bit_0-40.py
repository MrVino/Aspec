...
image_data20 = imread('../Basler spectra/Lasers/Climate chamber/16bit/0-40/ClimateChamberT20_pos3200.tiff').astype(np.float32)
...
for t in temperatures:
    ...
    image_data = imread('../Basler spectra/Lasers/Climate chamber/16bit/0-40/ClimateChamberT'+str(t)+'_pos3200.tiff').astype(np.float32)
